...
class App{
	public static void main(String[] args){
		...
		System.out.println("Name of the Student S01 is : " + S01.name);
		System.out.println("Marks of S01 is: " + S01.marks);
		...
		System.out.println("Name of the Student S02 is : " + S02.name);
		System.out.println("Marks of S02 is: " + S02.marks);
